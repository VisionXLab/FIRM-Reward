...
def _get_config(base_model="kontext", n_gpus=1, gradient_step_per_epoch=1, reward_fn={}, name=""):
    ...
    config.run_name = f"nft_{base_model}_{name}_qwen25_vl_32b_logits"
    config.logdir = f"logs/nft/qwen25_vl_32b_non_logits/{base_model}/{name}"
    config.save_dir = f"logs/nft/qwen25_vl_32b_non_logits/{base_model}/{name}"
