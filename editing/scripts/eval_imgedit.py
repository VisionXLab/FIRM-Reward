...
def call_gpt(original_image_path, result_image_path, edit_prompt, edit_type, prompts):
    try:
        ...
        client = OpenAI(
            api_key="sk-SK8nljvMHSnhF5IDQYBeoS1qLvvsLYOMS5VbXUwTPAtqtTq9",
        ...
        response = client.chat.completions.create(
            ...
            messages=[{
                ...
                "content": [
                    ...
                    {"type": "image_url", "image_url": {"url": f"data:image/jpg;base64,{original_image_base64}"}},
                    {"type": "image_url", "image_url": {"url": f"data:image/jpg;base64,{result_image_base64}"}}
                ]
            }]
        )
