...
def main():
    ...
    parser.add_argument("--pretrained_name_or_path", type=str, default="black-forest-labs/FLUX.1-Kontext-dev")
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="results/qwen_image_edit_reward_model_150steps",
